    ...
    $.extend($, {
        ...
        makeAjaxRequest: function (e, i, n) {
            ...
            a.onreadystatechange = function () {
                if (4 == a.readyState) {
                    a.onreadystatechange = function () {};
                    if ((200 <= a.status && a.status < 300) || (0 === a.status && "http:" !== s && "https:" !== s)) i(a);
                    else {
                ...
                if (window.XDomainRequest) {
                    ...
                    if (c) {
                        ...
                        c.onerror = function (e) {
                            $.isFunction(n) &&
                                n({ responseText: c.responseText, status: 444, statusText: "An error happened. Due to an XDomainRequest deficiency we can not extract any information about this error. Upgrade your browser." });
                        };
                        try {
                            c.open("GET.html", e);
                            c.send();
...
!(function (v) {
        ...
        f[this.hash] = {
            ...
            keyup: function (e) {
                !(function (e, t) {
                    if (e.keyUpHandler) {
                        t = v.getEvent(t);
                        e.keyUpHandler({ eventSource: e, keyCode: t.keyCode ? t.keyCode : t.charCode, ctrl: t.ctrlKey, shift: t.shiftKey, alt: t.altKey, meta: t.metaKey, originalEvent: t, preventDefaultAction: !1, userData: e.userData }) ||
                            v.cancelEvent(t);
                    }
                })(o, e);
            },
            keypress: function (e) {
                !(function (e, t) {
                    if (e.keyHandler) {
                        t = v.getEvent(t);
                        e.keyHandler({ eventSource: e, keyCode: t.keyCode ? t.keyCode : t.charCode, ctrl: t.ctrlKey, shift: t.shiftKey, alt: t.altKey, meta: t.metaKey, originalEvent: t, preventDefaultAction: !1, userData: e.userData }) ||
                            v.cancelEvent(t);
                    }
                })(o, e);
            },
            focus: function (e) {
                !(function (e, t) {
                    if (e.focusHandler) {
                        t = v.getEvent(t);
                        !1 === e.focusHandler({ eventSource: e, originalEvent: t, preventDefaultAction: !1, userData: e.userData }) && v.cancelEvent(t);
                    }
                })(o, e);
            },
            blur: function (e) {
                !(function (e, t) {
                    if (e.blurHandler) {
                        t = v.getEvent(t);
                        !1 === e.blurHandler({ eventSource: e, originalEvent: t, preventDefaultAction: !1, userData: e.userData }) && v.cancelEvent(t);
                    }
                })(o, e);
            },
            wheel: function (e) {
            ...
            mousedown: function (e) {
                !(function (e, t) {
                    var i;
                    t = v.getEvent(t);
                    i = { id: v.MouseTracker.mousePointerId, type: "mouse", isPrimary: !0, currentPos: g(t), currentTime: v.now() };
            ...
            touchstart: function (e) {
                !(function (e, t) {
                    ...
                    for (n = 0; n < s; n++) a.push({ id: t.changedTouches[n].identifier, type: "touch", currentPos: g(t.changedTouches[n]), currentTime: i });
                    N(e, t, a);
                    for (n = 0; n < h.length; n++)
                        if (h[n] !== e && h[n].isTracking() && x(h[n].element, e.element)) {
                            r = [];
                            for (o = 0; o < s; o++) r.push({ id: t.changedTouches[o].identifier, type: "touch", currentPos: g(t.changedTouches[o]), currentTime: i });
                            N(h[n], t, r);
                        }
                    if (V(e, t, a, 0)) {
                        v.stopEvent(t);
    ...
    v.MouseTracker.gesturePointVelocityTracker =
        ((l = []),
        (c = s = 0),
        {
    ...
    function o(e) {
        ...
        for (t = 0; t < n; t++)
            if (0 < i.activePointersLists[t].captureCount) {
    ...
    function a(e, t) {
        ...
        if ("mouse" === t) return { upName: "mouseup", upHandler: i.mouseupcaptured, moveName: "mousemove", moveHandler: i.mousemovecaptured };
        if ("touch" === t) return { upName: "touchend", upHandler: i.touchendcaptured, moveName: "touchmove", moveHandler: i.touchmovecaptured };
    ...
    function u(e, t, i) {
        ...
        o.captureCount += i || 1;
        if (1 === o.captureCount)
            if (v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9) e.element.setCapture(!0);
            else {
    ...
    function d(e, t, i) {
        ...
        o.captureCount -= i || 1;
        if (0 === o.captureCount)
            if (v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9) e.element.releaseCapture();
            else {
                n = a(e, v.MouseTracker.havePointerEvents ? "pointerevent" : t);
    ...
    function p(e) {
        var t;
        if (v.MouseTracker.unprefixedPointerEvents) t = e.pointerType;
        else
    ...
    function T(e, t, i) {
        ...
        n = t.deltaY < 0 ? 1 : -1;
        e.scrollHandler &&
            !1 === e.scrollHandler({ eventSource: e, pointerType: "mouse", position: m(t, e.element), scroll: n, shift: t.shiftKey, isTouchEvent: !1, originalEvent: i, preventDefaultAction: !1, userData: e.userData }) &&
            v.cancelEvent(i);
    }
    function x(e, t) {
        if (e === t) return !1;
    ...
    function S(e, t) {
        N(e, t, [{ id: v.MouseTracker.mousePointerId, type: "mouse", isPrimary: !0, currentPos: g(t), currentTime: v.now() }]);
    }
    function E(e, t) {
        W(e, t, [{ id: v.MouseTracker.mousePointerId, type: "mouse", isPrimary: !0, currentPos: g(t), currentTime: v.now() }]);
    }
    function P(e) {
        return v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9 ? (1 === e ? 0 : 2 === e ? 2 : 4 === e ? 1 : -1) : e;
    }
    function R(e, t) {
        U(e, (t = v.getEvent(t)), [{ id: v.MouseTracker.mousePointerId, type: "mouse", isPrimary: !0, currentPos: g(t), currentTime: v.now() }], P(t.button)) && d(e, "mouse");
    }
    function _(e, t) {
        j(e, (t = v.getEvent(t)), [{ id: v.MouseTracker.mousePointerId, type: "mouse", isPrimary: !0, currentPos: g(t), currentTime: v.now() }]);
    }
    function b(e, t, i) {
        var n,
            o = i.getLength(),
    ...
    function O(e, t) {
        var i,
            ...
            o = [];
        for (i = 0; i < n; i++) o.push({ id: t.changedTouches[i].identifier, type: "touch", currentPos: g(t.changedTouches[i]), currentTime: v.now() });
        j(e, t, o);
        v.cancelEvent(t);
    }
    function I(e, t) {
        t.currentTarget === t.relatedTarget || x(t.currentTarget, t.relatedTarget) || N(e, t, [{ id: t.pointerId, type: p(t), isPrimary: t.isPrimary, currentPos: g(t), currentTime: v.now() }]);
    }
    function k(e, t) {
        t.currentTarget === t.relatedTarget || x(t.currentTarget, t.relatedTarget) || W(e, t, [{ id: t.pointerId, type: p(t), isPrimary: t.isPrimary, currentPos: g(t), currentTime: v.now() }]);
    }
    function B(e, t) {
        var i;
        if (V(e, t, [(i = { id: t.pointerId, type: p(t), isPrimary: t.isPrimary, currentPos: g(t), currentTime: v.now() })], t.button)) {
            v.stopEvent(t);
            u(e, i.type);
        }
    ...
    function M(e, t) {
        var i;
        U(e, t, [(i = { id: t.pointerId, type: p(t), isPrimary: t.isPrimary, currentPos: g(t), currentTime: v.now() })], t.button) && d(e, i.type);
    }
    function z(e, t) {
        H(e, t);
    }
    ...
    function V(e, t, i, n) {
        ...
        void 0 !== t.buttons
            ? (l.buttons = t.buttons)
            : v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9
            ? 0 === n
                ? (l.buttons += 1)
                : 1 === n
                ? (l.buttons += 4)
        ...
        for (o = 0; o < h; o++) {
            ...
            if (1 === l.contacts)
                e.pressHandler &&
                    !1 ===
                        e.pressHandler({ eventSource: e, pointerType: r.type, position: w(r.contactPos, e.element), buttons: l.buttons, isTouchEvent: "touch" === r.type, originalEvent: t, preventDefaultAction: !1, userData: e.userData }) &&
                    v.cancelEvent(t);
                ...
                if (g) {
                    ...
                    if (0 === u.contacts) {
                        e.releaseHandler &&
                            ...
                            v.cancelEvent(t);
                        e.dragEndHandler &&
                            !l.currentPos.equals(l.contactPos) &&
                            !1 ===
                                e.dragEndHandler({
                                    eventSource: e,
                                    pointerType: l.type,
                        ...
                        if ((e.clickHandler || e.dblClickHandler) && l.insideElement) {
                            ...
                            if (e.dblClickHandler && h) {
                                ...
                                if (1 === u.clicks) {
                                    ...
                                    u.clicks = 0;
                                    c.lastClickPos.distanceTo(o) <= e.dblClickDistThreshold &&
                                        !1 ===
                                            e.dblClickHandler({
                                                eventSource: e,
                                                pointerType: l.type,
    ...
    function j(n, o, r) {
        ...
        if (0 === h.contacts)
            n.moveHandler &&
                ...
                v.cancelEvent(o);
        else if (1 === h.contacts) {
            if (n.moveHandler) {
                i = h.asArray()[0];
                !1 === n.moveHandler({ eventSource: n, pointerType: i.type, position: w(i.currentPos, n.element), buttons: h.buttons, isTouchEvent: "touch" === i.type, originalEvent: o, preventDefaultAction: !1, userData: n.userData }) &&
                    v.cancelEvent(o);
            }
            if (n.dragHandler) {
...
!(function (m) {
    ...
    m.Viewer = function (e) {
        var t,
            i = arguments,
            n = this;
        m.isPlainObject(e) || (e = { id: i[0], xmlPath: 1 < i.length ? i[1] : void 0, prefixUrl: 2 < i.length ? i[2] : void 0, controls: 3 < i.length ? i[3] : void 0, overlays: 4 < i.length ? i[4] : void 0 });
        if (e.config) {
        ...
        c[this.hash] = { fsBoundsDelta: new m.Point(1, 1), prevContainerSize: null, animating: !1, forceRedraw: !1, mouseInside: !1, group: null, zooming: !1, zoomFactor: null, lastZoomTime: null, fullPage: !1, onfullscreenchange: null };
    ...
    m.extend(m.Viewer.prototype, m.EventSource.prototype, m.ControlDock.prototype, {
        ...
        addTiledImage: function (i) {
            ...
            function r(e) {
                if (o.collectionMode) {
                    o.world.arrange({ immediately: e.options.collectionImmediately, rows: o.collectionRows, columns: o.collectionColumns, layout: o.collectionLayout, tileSize: o.collectionTileSize, tileMargin: o.collectionTileMargin });
        ...
        bindStandardControls: function () {
            ...
            if (this.showNavigationControl) {
                ...
                if (g) {
                    this.buttons = new m.ButtonGroup({ buttons: p, clickTimeThreshold: this.clickTimeThreshold, clickDistThreshold: this.clickDistThreshold });
                    this.navControl = this.buttons.element;
                    this.addHandler("open", m.delegate(this, A));
                    this.toolbar
                        ? this.toolbar.addControl(this.navControl, { anchor: this.navigationControlAnchor || m.ControlAnchor.TOP_LEFT })
                        : this.addControl(this.navControl, { anchor: this.navigationControlAnchor || m.ControlAnchor.TOP_LEFT });
                }
            }
            return this;
        },
    ...
    function d(e, t) {
        ...
        return new m.Overlay({ element: i, location: o, placement: c, onDraw: t.onDraw, checkResize: t.checkResize, width: r, height: s, rotationMode: t.rotationMode });
    }
    function s(e, t) {
        var i;
    ...
    function l(e) {
        var t = { originalEvent: e.originalEvent, preventDefaultAction: e.preventDefaultAction, preventVerticalPan: e.preventVerticalPan, preventHorizontalPan: e.preventHorizontalPan };
    ...
    function w(e) {
        ...
        var i = { tracker: e.eventSource, position: e.position, quick: e.quick, shift: e.shift, originalEvent: e.originalEvent, preventDefaultAction: e.preventDefaultAction };
    ...
    function y(e) {
        var t;
        var i = { tracker: e.eventSource, position: e.position, shift: e.shift, originalEvent: e.originalEvent, preventDefaultAction: e.preventDefaultAction };
    ...
    function T(e) {
        var t;
        var i = { tracker: e.eventSource, position: e.position, delta: e.delta, speed: e.speed, direction: e.direction, shift: e.shift, originalEvent: e.originalEvent, preventDefaultAction: e.preventDefaultAction };
...
!(function (c) {
    c.Navigator = function (i) {
        ...
        i.controlOptions.anchor != c.ControlAnchor.NONE &&
            (function (e, t) {
                e.margin = "0px";
        ...
        this.innerTracker = new c.MouseTracker({ element: this.element, dragHandler: c.delegate(this, a), clickHandler: c.delegate(this, s), releaseHandler: c.delegate(this, l), scrollHandler: c.delegate(this, h) });
    ...
    function s(e) {
        var t = { tracker: e.eventSource, position: e.position, quick: e.quick, shift: e.shift, originalEvent: e.originalEvent, preventDefaultAction: e.preventDefaultAction };
    ...
    function a(e) {
        var t = { tracker: e.eventSource, position: e.position, delta: e.delta, speed: e.speed, direction: e.direction, shift: e.shift, originalEvent: e.originalEvent, preventDefaultAction: e.preventDefaultAction };
    ...
    function h(e) {
        this.viewer.raiseEvent("navigator-scroll", { tracker: e.eventSource, position: e.position, scroll: e.scroll, shift: e.shift, originalEvent: e.originalEvent });
        return !1;
    }
    function u(e, t) {
        i(e, "rotate(" + t + "deg)");
...
!(function (d) {
    d.TileSource = function (e, t, i, n, o, r) {
        ...
        var a,
            l,
            h = arguments;
        a = d.isPlainObject(e) ? e : { width: h[0], height: h[1], tileSize: h[2], tileOverlap: h[3], minLevel: h[4], maxLevel: h[5] };
...
!(function (g) {
    g.DziTileSource = function (e, t, i, n, o, r, s, a, l) {
        var h, c, u, d;
        d = g.isPlainObject(e) ? e : { width: e, height: t, tileSize: i, tileOverlap: n, tilesUrl: o, fileFormat: r, displayRects: s, minLevel: a, maxLevel: l };
        this._levelRects = {};
    ...
    g.extend(g.DziTileSource.prototype, g.TileSource.prototype, {
        ...
        configure: function (e, t) {
            ...
            i = (g.isPlainObject(e)
                ? p
                : function (e, t) {
                      if (!t || !t.documentElement) throw new Error(g.getString("Errors.html"));
                      var i,
                          n,
                          o,
                          r,
    ...
    function p(e, t) {
        ...
        return g.extend(!0, { width: h, height: c, tileSize: u, tileOverlap: d, minLevel: null, maxLevel: null, tilesUrl: r, fileFormat: s, displayRects: p }, t);
    }
})(OpenSeadragon);
!(function (h) {
    ...
    h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
        ...
        configure: function (e, t) {
            ...
            var r = (function (e) {
                if (!e || !e.documentElement) throw new Error(h.getString("Errors.html"));
    ...
    function u(e) {
        var t = [];
        for (var i = 0; i < e.sizes.length; i++) t.push({ url: e["@id"] + "/full/" + e.sizes[i].width + "," + (3 === e.version ? e.sizes[i].height : "") + "/0/default." + e.tileFormat, width: e.sizes[i].width, height: e.sizes[i].height });
    ...
    l.LegacyTileSource = function (e) {
        ...
        t.levels = (function (e) {
            var t,
                i,
                n = [];
            for (i = 0; i < e.length; i++) (t = e[i]).height && t.width && t.url ? n.push({ url: t.url, width: Number(t.width), height: Number(t.height) }) : l.console.error("Unsupported image format: %s", t.url ? t.url : "<no URL>");
        ...
        l.extend(!0, t, { width: i, height: n, tileSize: Math.max(n, i), tileOverlap: 0, minLevel: 0, maxLevel: 0 < t.levels.length ? t.levels.length - 1 : 0 });
    ...
    l.extend(l.LegacyTileSource.prototype, l.TileSource.prototype, {
        ...
        configure: function (e, t) {
            return (l.isPlainObject(e)
                ? h
                : function (e, t) {
                      if (!t || !t.documentElement) throw new Error(l.getString("Errors.html"));
                      var i,
                          n,
                          o = t.documentElement,
                          r = o.tagName,
                      ...
                      if ("image" == r)
                          try {
                              ...
                              for (n = 0; n < a.length; n++) {
                                  i = a[n];
                                  s.levels.push({ url: i.getAttribute("url"), width: parseInt(i.getAttribute("width"), 10), height: parseInt(i.getAttribute("height"), 10) });
                              }
                              return h(e, s);
                          } catch (e) {
...
!(function (o) {
    ...
    o.extend(o.Button.prototype, o.EventSource.prototype, {
        ...
        disable: function () {
            ...
            o.setElementOpacity(this.element, 0.2, !0);
        },
        enable: function () {
...
!(function (d) {
    ...
    d.ReferenceStrip = function (e) {
        ...
        d.setElementOpacity(this.element, 0.8);
        this.viewer = r;
    ...
    function h(e, t, i) {
        ...
        o = Math.ceil(t / n) + 5;
        for (l = o = (o = (r = Math.ceil((Math.abs(i) + t) / n) + 1) - o) < 0 ? 0 : o; l < r && l < e.panels.length; l++)
            if (!(h = e.panels[l]).activePanel) {
                var c;
...
!(function (s) {
    s.Spring = function (e) {
        ...
        s.extend(!0, this, e);
        this.current = { value: "number" == typeof this.initial ? this.initial : this._exponential ? 0 : 1, time: s.now() };
...
!(function (h) {
    ...
    h.Tile.prototype = {
        ...
        getTranslationForEdgeSmoothing: function (e, t, i) {
            ...
            return new h.Point(n, o).minus(
                this.position
                    .times(h.pixelDensityRatio)
                    .times(e || 1)
                    .apply(function (e) {
                        return e % 1;
                    })
...
!(function (p) {
    p.Viewport = function (e) {
        ...
        this.centerSpringX = new p.Spring({ initial: 0, springStiffness: this.springStiffness, animationTime: this.animationTime });
        this.centerSpringY = new p.Spring({ initial: 0, springStiffness: this.springStiffness, animationTime: this.animationTime });
        this.zoomSpring = new p.Spring({ exponential: !0, initial: 1, springStiffness: this.springStiffness, animationTime: this.animationTime });
    ...
    p.Viewport.prototype = {
        ...
        getCenter: function (e) {
            ...
            s = this._pixelFromPoint(this.zoomPoint, r)
                .minus(t)
        ...
        _fitBounds: function (e, t) {
            ...
            var d = (s = s.rotate(-this.getRotation()))
                .getTopLeft()
                .times(a)
                .minus(c.getTopLeft().times(u))
                .divide(a - u);
        ...
        _pixelFromPointNoRotate: function (e, t) {
            return e
                ...
                .plus(new p.Point(this._margins.left, this._margins.top));
        },
        ...
        pointFromPixelNoRotate: function (e, t) {
            ...
            return e
                .minus(new p.Point(this._margins.left, this._margins.top))
...
!(function (y) {
    ...
    y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
        ...
        setCroppingPolygons: function (e) {
            function t(e) {
                return e.map(function (e) {
                    try {
                        if ((t = e) instanceof y.Point || ("number" == typeof t.x && "number" == typeof t.y)) return { x: e.x, y: e.y };
                        throw new Error();
                    } catch (e) {
        ...
        _updateViewport: function () {
            ...
            for (var h = r; o <= h; h--) {
                ...
                s = m(this, a, c, h, Math.min(1, (u - 0.5) / 0.5), g / Math.abs(g - d), t, l, s);
            ...
            !(function (n, e) {
                ...
                if (!o) {
                    0 !== n.viewport.degrees && n._drawer._offsetForRotation({ degrees: n.viewport.degrees, useSketch: i });
                    n.getRotation(!0) % 360 != 0 && n._drawer._offsetForRotation({ degrees: n.getRotation(!0), point: n.viewport.pixelFromPointNoRotate(n._getRotationPoint(!0), !0), useSketch: i });
                    0 === n.viewport.degrees && n.getRotation(!0) % 360 == 0 && n._drawer.viewer.viewport.getFlip() && n._drawer._flip();
                }
                var h = !1;
                if (n._clip) {
                ...
                if (i) {
                    if (o) {
                        0 !== n.viewport.degrees && n._drawer._offsetForRotation({ degrees: n.viewport.degrees, useSketch: !1 });
                        n.getRotation(!0) % 360 != 0 && n._drawer._offsetForRotation({ degrees: n.getRotation(!0), point: n.viewport.pixelFromPointNoRotate(n._getRotationPoint(!0), !0), useSketch: !1 });
                    }
                    n._drawer.blendSketch({ opacity: n.opacity, scale: o, translate: r, compositeOperation: n.compositeOperation, bounds: l });
                    if (o) {
                        ...
                        callback: function (e, t, i) {
                            !(function (t, i, e, n, o, r) {
                                if (!n) {
                                    ...
                                    t.viewer.raiseEvent("tile-load-failed", { tile: i, tiledImage: t, time: e, message: o, tileRequest: r });
                                    i.loading = !1;
                                    i.exists = !1;
                                    return;
                                }
    ...
    function m(e, t, i, n, o, r, s, a, l) {
        ...
        e.viewer && e.viewer.raiseEvent("update-level", { tiledImage: e, havedrawn: t, level: n, opacity: o, visibility: r, drawArea: s, topleft: h, bottomright: c, currenttime: a, best: l });
        S(e.coverage, n);
    ...
    function T(e, t, i, n, o, r, s, a, l, h, c, u) {
        ...
        !(function (e, t, i, n, o, r) {
            ...
            e.isRightMost && r.wrapHorizontal && (c.x += 0.75);
            e.isBottomMost && r.wrapVertical && (c.y += 0.75);
            e.position = l;
            e.size = c;
            e.squaredDistance = p;
            e.visibility = o;
    ...
    function v(e, t, i, n, o) {
        ...
        e.viewer.raiseEvent("tile-loaded", { tile: t, tiledImage: e, tileRequest: o, image: i, getCompletionCallback: s });
        s()();
    }
    function f(e, t, i, n) {
        var o, r, s, a;
